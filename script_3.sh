...
./waf --run "scratch/project-test --Interval=0.007 --Window=0.5 --PacketSize=1000 --Filename=50veh-false-false --MaxVehicles=50 --Project1=False --Project2=False"
./waf --run "scratch/project-test --Interval=0.007 --Window=0.5 --PacketSize=1000 --Filename=150veh-false-false --MaxVehicles=150 --Project1=False --Project2=False"
...
./waf --run "scratch/project-test --Interval=0.007 --Window=0.5 --PacketSize=1000 --Filename=150veh-false-true --MaxVehicles=150 --Project1=False --Project2=True"
